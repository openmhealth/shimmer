...
/**
 * A mapper from segment nodes in Moves Resource API <code>/user/storyline/daily</code> responses to data points.
 *
 * @author Emerson Farrugia
 * @author Jared Sieling
 * @see <a href="https://dev.moves-app.com/docs/api_storyline">API documentation</a>
 */
public abstract class MovesSegmentNodeDataPointMapper<T extends SchemaSupport> extends MovesDataPointMapper<T> {
