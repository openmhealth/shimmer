 ...
 */
@Component
@ConfigurationProperties(prefix = "openmhealth.shim.ginsberg")
public class GinsbergConfig implements ShimConfig {
    ...
    public String getClientId() {
        ApplicationAccessParameters parameters =
            applicationParametersRepo.findByShimKey(GinsbergShim.SHIM_KEY);
