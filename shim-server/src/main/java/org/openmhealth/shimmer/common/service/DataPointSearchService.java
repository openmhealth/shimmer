...
/**
 * A service used to search for data points.
 *
...
public interface DataPointSearchService {
    ...
    /**
     * @param criteria the criteria to use to filter the search
     * @return the result of the search
     */
    DataPointSearchResult findDataPoints(DataPointSearchCriteria criteria);
}
