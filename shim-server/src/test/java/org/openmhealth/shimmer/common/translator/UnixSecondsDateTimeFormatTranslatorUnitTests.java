...
public class UnixSecondsDateTimeFormatTranslatorUnitTests {
    ...
    @Test
    public void translateShouldReturnCorrectUnixSecondsWhenOffsetDateTimeInUtc() {


//        OffsetDateTime dateTimeInUtc = OffsetDateTime.parse();
//        String translatedDateTime = translator.translate(dateTimeInUtc);
//        
    }
}
