...
public class MisfitSleepDurationDataPointMapperUnitTests extends DataPointMapperUnitTests {
    ...
    public void asDataPointsShouldReturnEmptyListIfAwake() throws IOException {
        ...
        List<DataPoint<SleepDuration2>> dataPoints = mapper.asDataPoints(node);
    ...
    public void asDataPointsShouldReturnCorrectDataPoints() {
        ...
        SleepDuration2 sleepDuration = new SleepDuration2.Builder(new DurationUnitValue(SECOND, 10140), effectiveTimeInterval)
                .build();
    ...
    public void asDataPointsShouldSetModalityAsSensedOnlyWhenAutodetectedIsTrue() throws IOException {
        ...
        List<DataPoint<SleepDuration2>> dataPoints = mapper.asDataPoints(responseNodeForSleepSensing);
