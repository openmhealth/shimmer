...
public class FitbitBodyMassIndexDataPointMapperUnitTests extends DataPointMapperUnitTests {
    ...
    public void initializeResponseNode() throws IOException {
        ...
        ClassPathResource resource =
                new ClassPathResource("org/openmhealth/shim/fitbit/mapper/fitbit-get-body-weight.json");
    ...
    public void asDataPointsShouldReturnCorrectDataPoints() {
        ...
        testFitbitBodyMassIndexDataPoint(dataPoints.get(0), 21.48, "2015-05-13T18:28:59Z", 1431541739000L);
        testFitbitBodyMassIndexDataPoint(dataPoints.get(1), 21.17, "2015-05-14T11:51:57Z", 1431604317000L);
        testFitbitBodyMassIndexDataPoint(dataPoints.get(2), 21.99, "2015-05-22T18:12:06Z", 1432318326000L);
        testFitbitBodyMassIndexDataPoint(dataPoints.get(3), 21.65, "2015-05-24T15:15:25Z", 1432480525000L);

    }

    public void testFitbitBodyMassIndexDataPoint(DataPoint<BodyMassIndex> dataPoint, double bodyMassIndexValue,
            String timeString, long logId) {

        TypedUnitValue<BodyMassIndexUnit> bmiValue =
                new TypedUnitValue<>(KILOGRAMS_PER_SQUARE_METER, bodyMassIndexValue);

        BodyMassIndex expectedBodyMassIndex = new BodyMassIndex.Builder(bmiValue)
                .setEffectiveTimeFrame(OffsetDateTime.parse(timeString))
                .build();

        assertThat(dataPoint.getBody(), equalTo(expectedBodyMassIndex));
        assertThat(dataPoint.getHeader().getBodySchemaId(), equalTo(SCHEMA_ID));
