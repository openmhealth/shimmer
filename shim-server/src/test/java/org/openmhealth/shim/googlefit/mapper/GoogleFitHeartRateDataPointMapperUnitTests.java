...
public class GoogleFitHeartRateDataPointMapperUnitTests extends GoogleFitDataPointMapperUnitTests<HeartRate> {
    ...
    public void initializeResponseNode() throws IOException {
        ClassPathResource resource = new ClassPathResource("org/openmhealth/shim/googlefit/mapper/googlefit-heart-rate.json");
    ...
    public void asDataPointsShouldReturnCorrectDataPoints() {
        List<DataPoint<HeartRate>> dataPoints = mapper.asDataPoints(singletonList(responseNode));
        testGoogleFitDataPoint(dataPoints.get(0), createFloatingPointTestProperties(54,"2015-01-30T15:37:48.186Z",null,"raw:com.google.heart_rate.bpm:com.azumio.instantheartrate.full:"));
        testGoogleFitDataPoint(dataPoints.get(1), createFloatingPointTestProperties(58.0,"2015-07-10T14:34:32.914Z","2015-07-10T14:34:33.915Z","raw:com.google.heart_rate.bpm:si.modula.android.instantheartrate:"));
    }
