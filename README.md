...
| withings              | [heart_rate](http://oauth.withings.com/api/doc#api-Measure-get_measure)                                          | [omh:heart-rate:1.1](http://www.openmhealth.org/documentation/#/schema-docs/schema-library/schemas/omh_heart-rate)                | [WithingsDailyStepCountDataPointMapper](https://github.com/openmhealth/shimmer/blob/master/shim-server/src/main/java/org/openmhealth/shim/withings/mapper/WithingsDailyStepCountDataPointMapper.java)                 |
...
<sup>5</sup> *The Withings configuration controls whether to serve intraday or summary data (see `application.yaml` for details). Intraday activity requests are limited to 24 hours worth of data per request.*
