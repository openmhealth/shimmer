...
module webApp {
  ...
  angular.module('webApp', ['ngAnimate', 'ngCookies', 'ngTouch', 'ngSanitize', 'ngMessages', 'ngAria', 'ngResource', 'ngMockE2E', 'ui.router', 'ui.bootstrap', 'ui.select', 'ui.bootstrap.datetimepicker', 'ui.ace'])
    .run(runMock)
